		...
		if (file) {
			...
			reader.onloadend = () => {
				...
				if (fileName.length > MAX_LENGTH) {
					const firstHalf = fileName.slice(0, MAX_LENGTH / 2);
					const secondHalf = fileName.slice(-MAX_LENGTH / 2);
					setFileName(`${firstHalf}...${secondHalf}`);
				} else {
					...
					{fieldPropsWithoutShowLabel.value && (
						<div className='flex justify-center'>
							<div className='relative inline-flex'>
								...
								<img
									src={fieldPropsWithoutShowLabel.value}
